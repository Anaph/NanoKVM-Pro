  ...
  translation: {
    ...
    settings: {
      ...
      device: {
        title: 'Устройство',
        usbIdentity: {
          title: 'Идентификация USB-устройства',
          description: 'Изменить названия эмулируемых клавиатуры и мыши на стороне ПК',
          tip: 'Клавиатура, мышь и тачпад отдаются одним составным USB-устройством, поэтому у них общие VID/PID и названия. Применение изменений переподключает устройство: на подключённом ПК эмулируемые клавиатура и мышь ненадолго пропадут.',
          vendorId: 'Vendor ID',
          ...
          apply: 'Применить',
          applied: 'Идентификация USB применена',
          failed: 'Не удалось применить идентификацию USB',
          presets: {
